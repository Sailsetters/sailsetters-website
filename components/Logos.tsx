    ...
    return (
        <>
            <div className="flex flex-wrap items-center justify-center space-y-4">
                {logos.map((logo) => (
                    <div
                        className="h-32 w-full px-4 py-2 grayscale transition-all duration-200 ease-out hover:grayscale-0 sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 hover:scale-105 transform-gpu"
                        key={logo.src}
                    >
